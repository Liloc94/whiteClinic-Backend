    ...
    async create(dto) {
        ...
        try {
            ...
            for (const skillName of skillNames) {
                ...
                await queryRunner.manager.save(enginner_skill_entity_1.EngineerSkill, {
            ...
            const CommissionRate = await queryRunner.manager.findOneBy(commission_rate_entity_1.CommissionRates, {
            ...
            await queryRunner.manager.save(regular_holiday_entity_1.RegularHolidays, {
                engineerId: (await engineer).engineerId,
